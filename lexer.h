...
/**
//@file lexer.cpp
//@brief This is the part that takes in a raw text and transforms it
//in a list of tokens.
//@author Sanegv
///
...
/**
 * @ile lexer.cpp
 * @brief this is the part that takes in a raw text and transforms it into a list of tokens.
 *
 * @author Sanegv
 */
...
namespace Calc {
	...
	/**
	* @brief The lexer that will read an input stream and return tokens.
	*/
	class Lexer {
	private:		
